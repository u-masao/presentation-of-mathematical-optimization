...
- 全体的な指示
  ...
  - 全体にリラックスした感じにしたい
  - 複雑な概念を説明する際は具体的な例を入れてください。
  - 図やイラストが必要なページには、画像を配置するMarkdownを書いてください。
    - プロのイラストレーターにイラスト作成を依頼します
    - 画像生成用のプロンプトについて
      - スライドのキーメッセージ等のコンテキストを含めて記載してください
      - 100文字以上にしてください
      - シンプルでわかりやすいものを作らせてください
      - 画像の色合いは薄いブルーを基調にしてください
